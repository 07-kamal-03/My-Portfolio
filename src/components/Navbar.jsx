...
import resume from '../assets/Resume_Kamalraj_D.pdf'

export const Navbar = () => {
  return (
    <div className="mb-20 flex items-center justify-between py-6">
      <div className="flex flex-shrink-0 items-center">
        <img className='mx-2 logo' style={{ width: "200px" }} src={logo} alt="logo" />
      </div>
      <div className='m-8 flex item-center justify-center gap-2 lg:gap-4 text-2xl'>
