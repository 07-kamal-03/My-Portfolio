...
export const ABOUT_TEXT = `I am a dedicated and versatile Software developer with a passion for creating efficient and user-friendly web applications. With 1 year of professional experience, I have worked with a variety of technologies, including Drupal, CSS, JavaScript, HTML, React. My journey in web development began with a deep curiosity for how things work, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I enjoy staying active, exploring new technologies, and contributing to open-source projects.`;
...
export const EXPERIENCES = [
  {
    ...
    description: `Contributed to both UI(front end technologies) and CMS development on a Drupal-based project. Collaborated effectively with a team, enhancing teamwork, Error handling, version controll, platform development
 , native, communication and debugging skills. Gained valuable industry exposure, including coding, debugging, and project execution. Developed key skills in front-end development, problem-solving, and adaptability. Managed tasks efficiently, balancing deadlines and improving time management`,
    technologies: ["Drupal", "HTML", "CSS", "Javascript", "React.js"],
  },
];
...
export const EDUCATION = [
  {
    ...
    major: "Electronics and Communiaction Engineering",
    mark: "CGPA - 8.51   year: 2020 - 2024",
    year: "2020 - 2024"
  },
  {
    name: "Sri Ragavendra matric hr sec school",
    degree: "Higher Secondary School Certificate",
    major: "Biology Maths",
    mark: "Percentage - 75.16",
    year: "2020"
  },
  {
    name: "Sri Ragavendra matric hr sec school",
    ...
    major: "Major",
    mark: "Percentage - 80.4",
    year: "2018"
  },
];

export const CONTACT = {
  address: "Salem - 636116",
  phoneNo: "+91 9344821633",
  email: "kamalprs50@gmail.com",
};
